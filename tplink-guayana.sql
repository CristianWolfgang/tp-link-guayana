...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-05-2021 a las 17:26:19
...
INSERT INTO `products` (`id`, `name`, `type`, `about`, `price`, `company`, `stock`, `photo`, `new`, `promo`, `KEYBOARDS`) VALUES
...
(156, 'Corneta Portátil Jbl Charge 2 Inalámbrica Altavoz Bluetooth\r\n', 'music', 'El estéreo de doble canal, equipado con altavoz de bajos.protector impermeable, antivibración, polvo.La configuración de Bluetooth, utiliza el chip bluetooth de JL.', 50, 'UBL', 15, 'corneta.jpg', 0, 0, 'corneta joy bluetooh  estereo portatil inlalambrico'),
...
(154, 'Toshiba 43LF621U21 43-inch Smart 4K UHD with Dolby Vision - Fire TV Edition, Released 2020\r\n', 'tv', 'Voice remote with Alexa: Use your voice to watch live TV, launch apps, search for titles, play music, switch inputs, control smart home devices, and more.', 350, 'Toshiba', 70, 'tv-toshiba', 0, 0, 'tv television plasma 4k toshiba dolby alexa '),
...
--
ALTER TABLE `products`
  MODIFY `id` mediumint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;
